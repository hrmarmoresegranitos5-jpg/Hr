...
function buildCfg(){
  ...
  if(cfgTab===0){
    ...
    h+='<div class="cfg-row"><span class="cfg-lbl">API Key Anthropic (Secretária IA)</span><input class="cfginp" type="password" value="'+(e.apiKey||'')+'" placeholder="sk-proj-..." style="flex:1;text-align:right;font-family:monospace;" onchange="CFG.emp.apiKey=this.value;svCFG();toast(\'✓ API Key salva!\');"></div>';
